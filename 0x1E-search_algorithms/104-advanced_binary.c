...
/**
  ...
  * @array: Pointer to the first element of the search [sub]array.
  * @left: The starting index of the search [sub]array.
  * @right: The ending index of the search [sub]array.
  * @value: Search value.
  *
